...
public class QuanLiGiangVien {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch(n){
                ...
                break;
                case 4:
                    System.out.println("Thông tin gv cơ hữu: ");
                    for (GiangVien giangVien : giangvienList) {
                        if (giangVien instanceof GiangVienCoHuu) {
                            giangVien.displayq();
                        }else{
                            System.out.println("Không tồn tại gv cơ hữu ");
                        }
                    }
                break;
                case 5:
                    System.out.println("Thông tin gv thỉnh giảng");
                    for (GiangVien giangVien : giangvienList) {
                        if (giangVien instanceof GiangVienThinhGiang) {
                            giangVien.displayq();
                        }else{
                            System.out.println("Không tồn tại gv thỉnh giảng");
                        }
                    }
                break;
                case 6:
                ...
                break;
                case 7:
                    System.out.println("Giảng viên lương cao nhất: ");
    ...
    public static void menu(){
        ...
        System.out.println("3. Hiện thị toàn bộ thông tin");
        System.out.println("4. Hiển thị thông tin GV thỉnh giảng");
